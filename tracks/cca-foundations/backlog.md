...
5. **D5 (15%, high)** — context window / lost-in-the-middle; durable facts / case-facts; summarization/compaction; prompt caching; crash recovery; telemetry/evaluation; escalation/HITL; error propagation; large codebase. **5.1 case-facts/compaction — done 2026-09-18 evening; 5.2+5.3+5.5+5.6 — done 2026-09-21 evening; 5.4 large codebase — done 2026-09-22 morning (карта D5 6/6 ~100%, exam-ready ~36%).** Остаётся: hands-on compaction/HITL webhook / live large-repo drill.
...
| 12 | D5 5.4 large codebase (**done 2026-09-22 morning**) · next: D4 4.1 deepen · hands-on | 5.4 ✅; next 4.1, hands-on |
