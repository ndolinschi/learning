...
1. **D1 (27%, very high)** — agent vs workflow; циклы и `stop_reason`; coordinator/subagent; явная передача состояния; persistence; escalation; timeouts; bounded retries; human-in-the-loop. **Частично done 2026-09-16 morning; hooks 1.5 + enforcement/handoff 1.4 — done 2026-09-19 morning. Осталось: 1.7 session resume/fork.**
...
3. **D2 (18%, very high по плотности сценариев)** — описания/схемы tools; MCP servers/resources/prompts; custom vs built-in vs MCP vs Skills; Pre/PostToolUse hooks; изоляция ошибок. **Ядро schemas/isError/tool_choice/.mcp.json intro — done 2026-09-17 morning; hooks overlap covered via D1 2026-09-19; 2.5 built-in + deep MCP auth/resources — ещё нет.**
...
| 8 | Session resume/fork · Escalation deep · 5.3–5.5 · CI/CD `-p` · Batches · multi-pass | 1.7, 5.2–5.5, 3.6, 4.5, 4.6 |
